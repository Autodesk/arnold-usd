...
ASTR2(constantArrayInt, "constant ARRAY INT");
ASTR2(constantArrayString, "constant ARRAY STRING");
...
ASTR2(instance_crypto_object, "instance_crypto_object");
ASTR2(instance_hydraPrimId, "instance_hydra_primId");
...
ASTR(param_shader_fromspace);
ASTR(param_shader_space);
ASTR(param_shader_tospace);
