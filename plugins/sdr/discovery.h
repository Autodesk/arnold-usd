...
/// @file discovery.h
///
/// Sdr Discovery plugin for arnold shader nodes.
#pragma once
...
/// Sdr Discovery for arnold shader nodes.
class SdrArnoldDiscoveryPlugin : public SdrDiscoveryPlugin {
public:
    ...
    ///
    /// @param context SdrDiscvoeryPluginContext of the discovery process.
